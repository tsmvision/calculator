...
import {
  ...
  ResetState,
  PrevInputValue,
  ConvertCalculationStringToNumber,
  DisplayValueSanitizer,
  Calculate,
  InputValues
...
const convertCalculationStringToNumber: ConvertCalculationStringToNumber = (calculationString) => {
  return eval(calculationString);
};

const displayValueSanitizer: DisplayValueSanitizer = (value) => {
...
const Calculator: React.FC = () => {
  ...
  const inputValues: InputValues = (value) => {
          ...
          <Col>
            <div className={styles.calculator}>
              ...
              <div className={styles.buttonGroup}>
                ...
                <CalculatorButton className={styles.operatorButton} inputValues={inputValues} value={OPERATOR.MULTIPLY}
                                  label={"X"} />
              </div>
              <div className={styles.buttonGroup}>
                ...
                <CalculatorButton className={styles.operatorButton} inputValues={inputValues} value={OPERATOR.MINUS}
                                  label={"-"} />
              </div>
              <div className={styles.buttonGroup}>
                ...
                <CalculatorButton className={styles.operatorButton} inputValues={inputValues} value={OPERATOR.PLUS}
                                  label={"+"} />
              </div>
              <div className={styles.buttonGroup}>
